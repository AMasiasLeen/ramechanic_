    ...
    <div class="row justify-content-center">
        ...
        <div class="col-md-6 d-flex align-items-center">
            <div class="info-section p-4">
                ...
                <p class="text-light">Bienvenido al sistema de gestión de registros. Aquí podrás gestionar y controlar la información de forma eficiente y segura.</p>
                <p class="text-danger"><strong>¿No tienes una cuenta?</strong></p>
                <p class="text-light">Si aún no tienes un usuario, por favor contacta al administrador para que te genere un perfil, si planeas ser un usuario recurrente.</p>
            </div>
        </div>
