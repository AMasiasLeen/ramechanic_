            ...
            <div class="col-md-12 mb-4">
                <div class="card shadow-sm border-0">
                    <div class="card-body bg-primary text-white">
                        ...
                        <p class="text-center mb-0">Visualiza y gestiona las estadísticas del sistema de forma centralizada.</p>
                    </div>
                </div>
            </div>
...
<script>
    ...
    const top5Brands = {!! json_encode(array_slice($brandNames->toArray(), 0, 5)) !!};
