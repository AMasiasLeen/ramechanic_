                ...
                <div class="row">
                    <div class="col-12 col-md-6">
                        ...
                        <input name="identification" type="text" class="form-control" id="identification"
                            value="{{ old('identification') }}" required maxlength="13" pattern="\d{10}"
                ...
                <div class="row">
                    <div class="col-12 col-md-6">
                        ...
                        <input name="name" type="text" class="form-control" id="name" value="{{ old('name') }}"
                            required pattern="[a-zA-Z\s]+" title="Solo letras y espacios."
                    ...
                    <div class="col-12 col-md-6">
                        ...
                        <input name="password" type="password" class="form-control" id="password"
                            value="{{ old('password') }}" required minlength="8" placeholder="entre 8 y 20 caracteres">
                        @error('password')
                            <div class="alert alert-danger">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-md-6">
                        ...
                        <input name="phone" type="text" class="form-control" id="phone"
                            value="{{ old('phone') }}" pattern="\d{7,15}"
                ...
                <div class="row">
                    <div class="col-12 col-md-6">
                        ...
                        <input name="address" type="text" class="form-control" id="address"
                            value="{{ old('address') }}" maxlength="70" placeholder="Ingrese dirección (opcional)">
                        @error('address')
                            <div class="alert alert-danger">{{ $message }}</div>
                        @enderror
